...
#nullable enable
        public async Task<Stream?> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.CloudforceOneRequests_requestList body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.CloudforceOneRequests_requestList body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
