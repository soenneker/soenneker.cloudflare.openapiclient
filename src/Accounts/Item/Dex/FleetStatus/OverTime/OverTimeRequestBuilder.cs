...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Dex.FleetStatus.OverTime
{
    ...
    public partial class OverTimeRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Dex_fleet_status_over_time_Response_4XX_application_json">When receiving a 4XX status code</exception>
...
#nullable restore
        ...
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Dex.FleetStatus.OverTime.OverTimeRequestBuilder.OverTimeRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "4XX", global::Soenneker.Cloudflare.OpenApiClient.Models.Dex_fleet_status_over_time_Response_4XX_application_json.CreateFromDiscriminatorValue },
            };
