...
namespace Soenneker.Cloudflare.Accounts.Item.Botnet_feed.Asn.Item.Day_report
{
    ...
    public partial class Day_reportRequestBuilder : BaseRequestBuilder
    {
        ...
        public Day_reportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/botnet_feed/asn/{asn_id}/day_report", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.Accounts.Item.Botnet_feed.Asn.Item.Day_report.Day_reportRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Day_reportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/botnet_feed/asn/{asn_id}/day_report", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Day_reportRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
