...
namespace Soenneker.Cloudflare.Accounts.Item.Ai.Run.Cf.Mistral.Mistral7bInstructV02Lora
{
    ...
    public partial class Mistral7bInstructV02LoraRequestBuilder : BaseRequestBuilder
    {
        ...
        public Mistral7bInstructV02LoraRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/ai/run/@cf/mistral/mistral-7b-instruct-v0.2-lora", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.Accounts.Item.Ai.Run.Cf.Mistral.Mistral7bInstructV02Lora.Mistral7bInstructV02LoraRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Mistral7bInstructV02LoraRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/ai/run/@cf/mistral/mistral-7b-instruct-v0.2-lora", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Mistral7bInstructV02LoraRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
