...
{
    /// <summary>
    /// Builds and executes requests for operations under \accounts\{account-id}\ai\run\@cf\qwen\qwen3-30b-a3b-fp8
    /// </summary>
    ...
    public partial class Qwen330bA3bFp8RequestBuilder : BaseRequestBuilder
    {
        ...
        public Qwen330bA3bFp8RequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/ai/run/@cf/qwen/qwen3-30b-a3b-fp8{?queueRequest*,tags*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Ai.Run.Cf.Qwen.Qwen330bA3bFp8.Qwen330bA3bFp8RequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Qwen330bA3bFp8RequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/ai/run/@cf/qwen/qwen3-30b-a3b-fp8{?queueRequest*,tags*}", rawUrl)
        {
        }
        /// <summary>
