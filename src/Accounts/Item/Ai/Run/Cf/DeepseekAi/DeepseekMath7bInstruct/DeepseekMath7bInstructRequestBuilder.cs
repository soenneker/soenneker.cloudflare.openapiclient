...
namespace Soenneker.Cloudflare.Accounts.Item.Ai.Run.Cf.DeepseekAi.DeepseekMath7bInstruct
{
    ...
    public partial class DeepseekMath7bInstructRequestBuilder : BaseRequestBuilder
    {
        ...
        public DeepseekMath7bInstructRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/ai/run/@cf/deepseek-ai/deepseek-math-7b-instruct", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.Accounts.Item.Ai.Run.Cf.DeepseekAi.DeepseekMath7bInstruct.DeepseekMath7bInstructRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeepseekMath7bInstructRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/ai/run/@cf/deepseek-ai/deepseek-math-7b-instruct", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class DeepseekMath7bInstructRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
