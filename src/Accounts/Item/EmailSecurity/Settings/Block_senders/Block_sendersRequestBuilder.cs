...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.EmailSecurity.Settings.Block_senders
{
    ...
    public partial class Block_sendersRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Block_senders4XXError">When receiving a 4XX status code</exception>
...
#nullable restore
        ...
        public async Task<Stream> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "4XX", global::Soenneker.Cloudflare.OpenApiClient.Models.Block_senders4XXError.CreateFromDiscriminatorValue },
            };
