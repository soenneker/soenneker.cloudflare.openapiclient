...
{
    /// <summary>
    /// Builds and executes requests for operations under \accounts\{account-id}\devices\physical-devices
    /// </summary>
    ...
    public partial class PhysicalDevicesRequestBuilder : BaseRequestBuilder
    {
        ...
        public PhysicalDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/devices/physical-devices{?active_registrations,cursor,id*,include*,last_seen_user%2Eemail,per_page,search,seen_after,seen_before,sort_by,sort_order}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Devices.PhysicalDevices.PhysicalDevicesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PhysicalDevicesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/devices/physical-devices{?active_registrations,cursor,id*,include*,last_seen_user%2Eemail,per_page,search,seen_after,seen_before,sort_by,sort_order}", rawUrl)
        {
        }
        /// <summary>
        /// Lists WARP devices.
