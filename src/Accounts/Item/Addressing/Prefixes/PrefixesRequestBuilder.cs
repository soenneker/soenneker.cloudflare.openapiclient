...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Addressing.Prefixes
{
    ...
    public partial class PrefixesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Ip_address_management_prefixes_list_prefixes_Response_4XX_application_json">When receiving a 4XX status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Addressing_response_collection> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "4XX", global::Soenneker.Cloudflare.OpenApiClient.Models.Ip_address_management_prefixes_list_prefixes_Response_4XX_application_json.CreateFromDiscriminatorValue },
            };
        ...
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Ip_address_management_prefixes_add_prefix_Response_4XX_application_json">When receiving a 4XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Addressing_single_response> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Ip_address_management_prefixes_add_prefix_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                { "4XX", global::Soenneker.Cloudflare.OpenApiClient.Models.Ip_address_management_prefixes_add_prefix_Response_4XX_application_json.CreateFromDiscriminatorValue },
            };
