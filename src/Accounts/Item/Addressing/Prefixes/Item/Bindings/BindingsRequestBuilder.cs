...
{
    /// <summary>
    /// Builds and executes requests for operations under \accounts\{account-id}\addressing\prefixes\{prefix_id}\bindings
    /// </summary>
    ...
    public partial class BindingsRequestBuilder : BaseRequestBuilder
    {
        ...
        public BindingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/addressing/prefixes/{prefix_id}/bindings", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Addressing.Prefixes.Item.Bindings.BindingsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BindingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/addressing/prefixes/{prefix_id}/bindings", rawUrl)
        {
        }
        /// <summary>
