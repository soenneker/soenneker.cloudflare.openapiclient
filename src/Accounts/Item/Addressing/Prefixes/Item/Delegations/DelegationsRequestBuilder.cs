...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Addressing_schemasResponse_collection?> GetAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Ip_address_management_prefix_delegation_list_prefix_delegations_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Addressing_schemasResponse_collection> GetAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Ip_address_management_prefix_delegation_list_prefix_delegations_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.Addressing_schemasResponse_collection>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.Addressing_schemasResponse_collection.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Addressing_schemasSingle_response> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Ip_address_management_prefix_delegation_create_prefix_delegation_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.Addressing_schemasSingle_response>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.Addressing_schemasSingle_response.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// List all delegations for a given account IP prefix.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Ip_address_management_prefix_delegation_list_prefix_delegations_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Ip_address_management_prefix_delegation_list_prefix_delegations_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
