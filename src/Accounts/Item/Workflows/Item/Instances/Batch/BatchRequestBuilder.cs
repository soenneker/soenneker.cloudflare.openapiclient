...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Workflows.Item.Instances.Batch
{
    ...
    public partial class BatchRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_Response_400_application_json">When receiving a 400 status code</exception>
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_Response_404_application_json">When receiving a 404 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_Response_200_application_json?> PostAsync(List<global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_RequestBody_application_json> body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_Response_200_application_json> PostAsync(List<global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_RequestBody_application_json> body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_Response_400_application_json.CreateFromDiscriminatorValue },
                { "404", global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_Response_404_application_json.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_Response_200_application_json>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_Response_200_application_json.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Batch create new Workflow instances
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(List<global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_RequestBody_application_json> body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(List<global::Soenneker.Cloudflare.OpenApiClient.Models.Wor_batch_create_workflow_instance_RequestBody_application_json> body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
