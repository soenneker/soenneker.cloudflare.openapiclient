...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Vectorize.Indexes.Item.Upsert
{
    ...
    public partial class UpsertRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Vectorize___deprecated__upsert_vector_Response_default_application_json">When receiving a 4XX or 5XX status code</exception>
        [Obsolete("")]
...
#nullable restore
        ...
        public async Task<Stream> PostAsync(Stream body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "XXX", global::Soenneker.Cloudflare.OpenApiClient.Models.Vectorize___deprecated__upsert_vector_Response_default_application_json.CreateFromDiscriminatorValue },
            };
