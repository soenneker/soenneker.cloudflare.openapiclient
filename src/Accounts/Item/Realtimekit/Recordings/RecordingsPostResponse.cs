...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Realtimekit.Recordings
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public static new global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Realtimekit.Recordings.RecordingsPostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Realtimekit.Recordings.RecordingsPostResponse();
        }
        /// <summary>
