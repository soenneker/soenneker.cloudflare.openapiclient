...
#nullable restore
        ...
        public global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Realtimekit.Meetings.MeetingsPostRequestBody_preferred_region? PreferredRegion { get; set; }
        /// <summary>Recording Configurations to be used for this meeting. This level of configs takes higher preference over organization level configs on the RealtimeKit developer portal.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Realtimekit.Meetings.MeetingsPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Realtimekit.Meetings.MeetingsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Realtimekit.Meetings.MeetingsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Realtimekit.Meetings.MeetingsPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "preferred_region", n => { PreferredRegion = n.GetEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Realtimekit.Meetings.MeetingsPostRequestBody_preferred_region>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Realtimekit.Meetings.MeetingsPostRequestBody_preferred_region>("preferred_region", PreferredRegion);
