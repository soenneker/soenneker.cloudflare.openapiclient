...
{
    /// <summary>
    /// Builds and executes requests for operations under \accounts\{account-id}\images\v1\{image_id}
    /// </summary>
    ...
    public partial class WithImage_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithImage_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/images/v1/{image_id}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Images.V1.Item.WithImage_ItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithImage_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/images/v1/{image_id}", rawUrl)
        {
        }
        /// <summary>
