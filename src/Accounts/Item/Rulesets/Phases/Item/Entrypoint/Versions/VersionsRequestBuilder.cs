...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Rulesets.Phases.Item.Entrypoint.Versions
{
    ...
    public partial class VersionsRequestBuilder : BaseRequestBuilder
    {
        ...
        public VersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/rulesets/phases/{ruleset_phase}/entrypoint/versions", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Rulesets.Phases.Item.Entrypoint.Versions.VersionsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public VersionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/rulesets/phases/{ruleset_phase}/entrypoint/versions", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.ListAccountEntrypointRulesetVersions_Response_default_application_json">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> GetAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.ListAccountEntrypointRulesetVersions_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.ListAccountEntrypointRulesetVersions_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "XXX", global::Soenneker.Cloudflare.OpenApiClient.Models.ListAccountEntrypointRulesetVersions_Response_default_application_json.CreateFromDiscriminatorValue },
            };
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.ListAccountEntrypointRulesetVersions_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.ListAccountEntrypointRulesetVersions_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
