...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Rulesets.Item.Rules
{
    ...
    public partial class RulesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.CreateAccountRulesetRule_Response_default_application_json">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.CreateAccountRulesetRule_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.CreateAccountRulesetRule_RequestBody_application_json body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "XXX", global::Soenneker.Cloudflare.OpenApiClient.Models.CreateAccountRulesetRule_Response_default_application_json.CreateFromDiscriminatorValue },
            };
