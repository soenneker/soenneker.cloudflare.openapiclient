...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class AbuseReports_TrademarkReport : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The act property</summary>
        public global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport_act? Act { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport_host_notification? HostNotification { get; set; }
...
#endif
        /// <summary>Notification type based on the abuse type. NOTE: Copyright (DMCA) and Trademark reports cannot be anonymous.</summary>
        public global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport_owner_notification? OwnerNotification { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport"/> and sets the default values.
        /// </summary>
        public AbuseReports_TrademarkReport()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "act", n => { Act = n.GetEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport_act>(); } },
                { "comments", n => { Comments = n.GetStringValue(); } },
                { "company", n => { Company = n.GetStringValue(); } },
                { "email", n => { Email = n.GetStringValue(); } },
                { "email2", n => { Email2 = n.GetStringValue(); } },
                { "host_notification", n => { HostNotification = n.GetEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport_host_notification>(); } },
                { "justification", n => { Justification = n.GetStringValue(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "owner_notification", n => { OwnerNotification = n.GetEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport_owner_notification>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport_act>("act", Act);
            writer.WriteStringValue("comments", Comments);
            writer.WriteStringValue("company", Company);
            writer.WriteStringValue("email", Email);
            writer.WriteStringValue("email2", Email2);
            writer.WriteEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport_host_notification>("host_notification", HostNotification);
            writer.WriteStringValue("justification", Justification);
            writer.WriteStringValue("name", Name);
            writer.WriteEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReports_TrademarkReport_owner_notification>("owner_notification", OwnerNotification);
