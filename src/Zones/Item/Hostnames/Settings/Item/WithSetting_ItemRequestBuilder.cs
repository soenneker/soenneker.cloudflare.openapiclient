...
namespace Soenneker.Cloudflare.OpenApiClient.Zones.Item.Hostnames.Settings.Item
{
    ...
    public partial class WithSetting_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithSetting_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{identifier%2Did}/hostnames/settings/{setting_id}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Hostnames.Settings.Item.WithSetting_ItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithSetting_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{identifier%2Did}/hostnames/settings/{setting_id}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Per_hostname_tls_settings_list_Response_4XX_application_json">When receiving a 4XX status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.TlsCertificatesAndHostnames_per_hostname_settings_response_collection> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "4XX", global::Soenneker.Cloudflare.OpenApiClient.Models.Per_hostname_tls_settings_list_Response_4XX_application_json.CreateFromDiscriminatorValue },
            };
