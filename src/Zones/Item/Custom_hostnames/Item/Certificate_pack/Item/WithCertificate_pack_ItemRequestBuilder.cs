...
namespace Soenneker.Cloudflare.Zones.Item.Custom_hostnames.Item.Certificate_pack.Item
{
    ...
    public partial class WithCertificate_pack_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithCertificate_pack_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{identifier%2Did}/custom_hostnames/{custom_hostname_id}/certificate_pack/{certificate_pack_id}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.Zones.Item.Custom_hostnames.Item.Certificate_pack.Item.WithCertificate_pack_ItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCertificate_pack_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{identifier%2Did}/custom_hostnames/{custom_hostname_id}/certificate_pack/{certificate_pack_id}", rawUrl)
        {
        }
    }
}
