...
using System;
namespace Soenneker.Cloudflare.OpenApiClient.Zones.Item.Email.Sending
{
    /// <summary>
    /// Builds and executes requests for operations under \zones\{zone_identifier-id}\email\sending
    /// </summary>
    ...
    public partial class SendingRequestBuilder : BaseRequestBuilder
    {
        ...
        public SendingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{zone_identifier%2Did}/email/sending", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Email.Sending.SendingRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SendingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{zone_identifier%2Did}/email/sending", rawUrl)
        {
        }
    }
}
