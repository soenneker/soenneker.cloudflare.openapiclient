...
namespace Soenneker.Cloudflare.OpenApiClient.Zones.Item.LeakedCredentialChecks.Detections
{
    ...
    public partial class DetectionsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Leaked_credential_checks_response_custom_detection_collection"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Leaked_credential_checks_response_custom_detection_collection?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Leaked_credential_checks_response_custom_detection_collection> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.Leaked_credential_checks_response_custom_detection_collection>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.Leaked_credential_checks_response_custom_detection_collection.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Leaked_credential_checks_custom_detection body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Leaked_credential_checks_custom_detection body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
