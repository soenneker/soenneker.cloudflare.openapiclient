...
namespace Soenneker.Cloudflare.OpenApiClient.Zones.Item.Logs.Control
{
    ...
    public partial class ControlRequestBuilder : BaseRequestBuilder
    {
        ...
        public ControlRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{identifier%2Did}/logs/control", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Logs.Control.ControlRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ControlRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{identifier%2Did}/logs/control", rawUrl)
        {
        }
    }
}
