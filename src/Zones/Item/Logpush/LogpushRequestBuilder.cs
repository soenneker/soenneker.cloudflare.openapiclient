...
{
    /// <summary>
    /// Builds and executes requests for operations under \zones\{zone_identifier-id}\logpush
    /// </summary>
    ...
    public partial class LogpushRequestBuilder : BaseRequestBuilder
    {
        ...
        public LogpushRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{zone_identifier%2Did}/logpush", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Logpush.LogpushRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LogpushRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{zone_identifier%2Did}/logpush", rawUrl)
        {
        }
    }
}
