...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Api_shield_schema_validation_extract_operations_from_schema_200?> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Api_gateway.User_schemas.Item.Operations.OperationsRequestBuilder.OperationsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Api_shield_schema_validation_extract_operations_from_schema_200> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Api_gateway.User_schemas.Item.Operations.OperationsRequestBuilder.OperationsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.Api_shield_schema_validation_extract_operations_from_schema_200>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.Api_shield_schema_validation_extract_operations_from_schema_200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieves all operations from the schema. Operations that already exist in API Shield Endpoint Management will be returned as full operations.
        /// </summary>
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Api_gateway.User_schemas.Item.Operations.GetFeatureQueryParameterType[]? Feature { get; set; }
#nullable restore
#else
            [QueryParameter("feature")]
            public global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Api_gateway.User_schemas.Item.Operations.GetFeatureQueryParameterType[] Feature { get; set; }
...
#nullable restore
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Api_gateway.User_schemas.Item.Operations.GetOperation_statusQueryParameterType? OperationStatus { get; set; }
