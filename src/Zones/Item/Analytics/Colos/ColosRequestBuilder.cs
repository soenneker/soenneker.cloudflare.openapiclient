...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.ZoneAnalyticsApi_colo_response?> GetAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Zone_analytics___deprecated__get_analytics_by_co_locations_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Analytics.Colos.ColosRequestBuilder.ColosRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.ZoneAnalyticsApi_colo_response> GetAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Zone_analytics___deprecated__get_analytics_by_co_locations_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Analytics.Colos.ColosRequestBuilder.ColosRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.ZoneAnalyticsApi_colo_response>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.ZoneAnalyticsApi_colo_response.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// This view provides a breakdown of analytics data by datacenter. Note: This is available to Enterprise customers only.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Zone_analytics___deprecated__get_analytics_by_co_locations_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Analytics.Colos.ColosRequestBuilder.ColosRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Zone_analytics___deprecated__get_analytics_by_co_locations_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Analytics.Colos.ColosRequestBuilder.ColosRequestBuilderGetQueryParameters>> requestConfiguration = default)
