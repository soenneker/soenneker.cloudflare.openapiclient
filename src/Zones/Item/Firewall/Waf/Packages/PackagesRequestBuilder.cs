...
{
    /// <summary>
    /// Builds and executes requests for operations under \zones\{zone_identifier-id}\firewall\waf\packages
    /// </summary>
    ...
    public partial class PackagesRequestBuilder : BaseRequestBuilder
    {
        ...
        public PackagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{zone_identifier%2Did}/firewall/waf/packages{?direction*,match*,name*,order*,page*,per_page*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Firewall.Waf.Packages.PackagesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PackagesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{zone_identifier%2Did}/firewall/waf/packages{?direction*,match*,name*,order*,page*,per_page*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Waf_packages_list_waf_packages_4XX">When receiving a 4XX status code</exception>
        [Obsolete("")]
...
#nullable restore
        ...
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Firewall_package_response_collection> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Firewall.Waf.Packages.PackagesRequestBuilder.PackagesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "4XX", global::Soenneker.Cloudflare.OpenApiClient.Models.Waf_packages_list_waf_packages_4XX.CreateFromDiscriminatorValue },
            };
...
#nullable restore
        ...
        public partial class PackagesRequestBuilderGetQueryParameters 
        {
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Firewall.Waf.Packages.GetDirectionQueryParameterType? Direction { get; set; }
            [QueryParameter("match")]
            public global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Firewall.Waf.Packages.GetMatchQueryParameterType? Match { get; set; }
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            [QueryParameter("name")]
...
#nullable restore
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Firewall.Waf.Packages.GetOrderQueryParameterType? Order { get; set; }
            [QueryParameter("page")]
