...
namespace Soenneker.Cloudflare.OpenApiClient.Zones.Item.Waiting_rooms.Item.Status
{
    ...
    public partial class StatusRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Waiting_room_get_waiting_room_status_4XX">When receiving a 4XX status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Waitingroom_status_response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "4XX", global::Soenneker.Cloudflare.OpenApiClient.Models.Waiting_room_get_waiting_room_status_4XX.CreateFromDiscriminatorValue },
            };
