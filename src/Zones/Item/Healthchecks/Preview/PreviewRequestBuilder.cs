...
namespace Soenneker.Cloudflare.OpenApiClient.Zones.Item.Healthchecks.Preview
{
    ...
    public partial class PreviewRequestBuilder : BaseRequestBuilder
    {
        ...
        public PreviewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{identifier%2Did}/healthchecks/preview", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.Healthchecks.Preview.PreviewRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PreviewRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{identifier%2Did}/healthchecks/preview", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Health_checks_create_preview_health_check_Response_4XX_application_json">When receiving a 4XX status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Healthchecks_single_response> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Healthchecks_query_healthcheck body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "4XX", global::Soenneker.Cloudflare.OpenApiClient.Models.Health_checks_create_preview_health_check_Response_4XX_application_json.CreateFromDiscriminatorValue },
            };
