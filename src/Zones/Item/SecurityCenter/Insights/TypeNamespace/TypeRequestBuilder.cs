...
{
    /// <summary>
    /// Builds and executes requests for operations under \zones\{identifier-id}\security-center\insights\type
    /// </summary>
    ...
    public partial class TypeRequestBuilder : BaseRequestBuilder
    {
        ...
        public TypeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{identifier%2Did}/security-center/insights/type{?dismissed*,issue_class*,issue_class%7Eneq*,issue_type*,issue_type%7Eneq*,product*,product%7Eneq*,severity*,severity%7Eneq*,subject*,subject%7Eneq*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.SecurityCenter.Insights.TypeNamespace.TypeRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TypeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zones/{identifier%2Did}/security-center/insights/type{?dismissed*,issue_class*,issue_class%7Eneq*,issue_type*,issue_type%7Eneq*,product*,product%7Eneq*,severity*,severity%7Eneq*,subject*,subject%7Eneq*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.SecurityCenter_valueCountsResponse?> GetAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Get_zone_security_center_insight_counts_by_type_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.SecurityCenter.Insights.TypeNamespace.TypeRequestBuilder.TypeRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.SecurityCenter_valueCountsResponse> GetAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Get_zone_security_center_insight_counts_by_type_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.SecurityCenter.Insights.TypeNamespace.TypeRequestBuilder.TypeRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Get_zone_security_center_insight_counts_by_type_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.SecurityCenter.Insights.TypeNamespace.TypeRequestBuilder.TypeRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Get_zone_security_center_insight_counts_by_type_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.SecurityCenter.Insights.TypeNamespace.TypeRequestBuilder.TypeRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable enable
            [QueryParameter("severity")]
            public global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.SecurityCenter.Insights.TypeNamespace.GetSeverityQueryParameterType[]? SeverityAsGetSeverityQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("severity")]
            public global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.SecurityCenter.Insights.TypeNamespace.GetSeverityQueryParameterType[] SeverityAsGetSeverityQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("severity%7Eneq")]
            public global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.SecurityCenter.Insights.TypeNamespace.GetSeverityNeqQueryParameterType[]? SeverityNeqAsGetSeverityNeqQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("severity%7Eneq")]
            public global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.SecurityCenter.Insights.TypeNamespace.GetSeverityNeqQueryParameterType[] SeverityNeqAsGetSeverityNeqQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class TypeRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Zones.Item.SecurityCenter.Insights.TypeNamespace.TypeRequestBuilder.TypeRequestBuilderGetQueryParameters>
        {
        }
    }
}
