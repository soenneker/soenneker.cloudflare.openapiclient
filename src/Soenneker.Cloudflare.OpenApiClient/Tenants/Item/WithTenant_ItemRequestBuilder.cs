...
namespace Soenneker.Cloudflare.OpenApiClient.Tenants.Item
{
    ...
    public partial class WithTenant_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        {
            get => new global::Soenneker.Cloudflare.OpenApiClient.Tenants.Item.Account_types.Account_typesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new global::Soenneker.Cloudflare.OpenApiClient.Tenants.Item.Entitlements.EntitlementsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The memberships property</summary>
        public global::Soenneker.Cloudflare.OpenApiClient.Tenants.Item.Memberships.MembershipsRequestBuilder Memberships
        {
...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.TenantsRetrieveTenant200?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.TenantsRetrieveTenant200> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.TenantsRetrieveTenant200>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.TenantsRetrieveTenant200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieves a Tenant by Tenant ID.
        /// </summary>
