...
namespace Soenneker.Cloudflare.OpenApiClient.Radar.Bgp.Timeseries
{
    ...
    public partial class TimeseriesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetBgpTimeseries200"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetBgpTimeseries400">When receiving a 400 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetBgpTimeseries200?> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Bgp.Timeseries.TimeseriesRequestBuilder.TimeseriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetBgpTimeseries200> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Bgp.Timeseries.TimeseriesRequestBuilder.TimeseriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetBgpTimeseries400.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetBgpTimeseries200>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetBgpTimeseries200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieves BGP updates over time. When requesting updates for an autonomous system, only BGP updates of type announcement are returned.
        /// </summary>
...
#nullable restore
        ...
        public partial class TimeseriesRequestBuilderGetQueryParameters 
        {
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Bgp.Timeseries.GetAggIntervalQueryParameterType? AggInterval { get; set; }
...
#nullable restore
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Bgp.Timeseries.GetFormatQueryParameterType? Format { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Bgp.Timeseries.GetUpdateTypeQueryParameterType[]? UpdateType { get; set; }
#nullable restore
#else
            [QueryParameter("updateType")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Bgp.Timeseries.GetUpdateTypeQueryParameterType[] UpdateType { get; set; }
