...
namespace Soenneker.Cloudflare.OpenApiClient.Radar.Attacks.Layer7.Top.Locations.Target
{
    ...
    public partial class TargetRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_attacks_layer7_top_target_location_200"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_attacks_layer7_top_target_location_404">When receiving a 404 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_attacks_layer7_top_target_location_200?> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Attacks.Layer7.Top.Locations.Target.TargetRequestBuilder.TargetRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_attacks_layer7_top_target_location_200> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Attacks.Layer7.Top.Locations.Target.TargetRequestBuilder.TargetRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "404", global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_attacks_layer7_top_target_location_404.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_attacks_layer7_top_target_location_200>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_attacks_layer7_top_target_location_200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieves the top target locations of and by layer 7 attacks. Values are a percentage out of the total layer 7 attacks. The target location is determined by the attacked zone&apos;s billing country, when available.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Attacks.Layer7.Top.Locations.Target.TargetRequestBuilder.TargetRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Attacks.Layer7.Top.Locations.Target.TargetRequestBuilder.TargetRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Attacks.Layer7.Top.Locations.Target.GetFormatQueryParameterType? Format { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Attacks.Layer7.Top.Locations.Target.GetMitigationProductQueryParameterType[]? MitigationProduct { get; set; }
#nullable restore
#else
            [QueryParameter("mitigationProduct")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Attacks.Layer7.Top.Locations.Target.GetMitigationProductQueryParameterType[] MitigationProduct { get; set; }
