...
namespace Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases
{
    ...
    public partial class AsesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AsesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/http/top/ases{?asn*,botClass*,browserFamily*,continent*,dateEnd*,dateRange*,dateStart*,deviceType*,format*,geoId*,httpProtocol*,httpVersion*,ipVersion*,limit*,location*,name*,os*,tlsVersion*}", rawUrl)
        {
        }
        /// <summary>
        /// Retrieves the top autonomous systems by HTTP requests.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByHttpRequests200"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByHttpRequests404">When receiving a 404 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByHttpRequests200?> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.AsesRequestBuilder.AsesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByHttpRequests200> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.AsesRequestBuilder.AsesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "404", global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByHttpRequests404.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByHttpRequests200>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByHttpRequests200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieves the top autonomous systems by HTTP requests.
        /// </summary>
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetBotClassQueryParameterType[]? BotClass { get; set; }
#nullable restore
#else
            [QueryParameter("botClass")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetBotClassQueryParameterType[] BotClass { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetBrowserFamilyQueryParameterType[]? BrowserFamily { get; set; }
#nullable restore
#else
            [QueryParameter("browserFamily")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetBrowserFamilyQueryParameterType[] BrowserFamily { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetDeviceTypeQueryParameterType[]? DeviceType { get; set; }
#nullable restore
#else
            [QueryParameter("deviceType")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetDeviceTypeQueryParameterType[] DeviceType { get; set; }
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetFormatQueryParameterType? Format { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetHttpProtocolQueryParameterType[]? HttpProtocol { get; set; }
#nullable restore
#else
            [QueryParameter("httpProtocol")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetHttpProtocolQueryParameterType[] HttpProtocol { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetHttpVersionQueryParameterType[]? HttpVersion { get; set; }
#nullable restore
#else
            [QueryParameter("httpVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetHttpVersionQueryParameterType[] HttpVersion { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetIpVersionQueryParameterType[]? IpVersion { get; set; }
#nullable restore
#else
            [QueryParameter("ipVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetIpVersionQueryParameterType[] IpVersion { get; set; }
...
#nullable enable
            [QueryParameter("os")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetOsQueryParameterType[]? Os { get; set; }
#nullable restore
#else
            [QueryParameter("os")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetOsQueryParameterType[] Os { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetTlsVersionQueryParameterType[]? TlsVersion { get; set; }
#nullable restore
#else
            [QueryParameter("tlsVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.GetTlsVersionQueryParameterType[] TlsVersion { get; set; }
