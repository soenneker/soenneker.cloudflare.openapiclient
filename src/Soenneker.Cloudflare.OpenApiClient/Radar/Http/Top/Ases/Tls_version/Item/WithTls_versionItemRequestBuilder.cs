...
namespace Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item
{
    ...
    public partial class WithTls_versionItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByTlsVersion200"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByTlsVersion404">When receiving a 404 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByTlsVersion200?> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.WithTls_versionItemRequestBuilder.WithTls_versionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByTlsVersion200> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.WithTls_versionItemRequestBuilder.WithTls_versionItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "404", global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByTlsVersion404.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByTlsVersion200>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopAsesByTlsVersion200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieves the top autonomous systems, by HTTP requests, of the requested TLS protocol version.
        /// </summary>
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetBotClassQueryParameterType[]? BotClass { get; set; }
#nullable restore
#else
            [QueryParameter("botClass")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetBotClassQueryParameterType[] BotClass { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetBrowserFamilyQueryParameterType[]? BrowserFamily { get; set; }
#nullable restore
#else
            [QueryParameter("browserFamily")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetBrowserFamilyQueryParameterType[] BrowserFamily { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetDeviceTypeQueryParameterType[]? DeviceType { get; set; }
#nullable restore
#else
            [QueryParameter("deviceType")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetDeviceTypeQueryParameterType[] DeviceType { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetHttpProtocolQueryParameterType[]? HttpProtocol { get; set; }
#nullable restore
#else
            [QueryParameter("httpProtocol")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetHttpProtocolQueryParameterType[] HttpProtocol { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetHttpVersionQueryParameterType[]? HttpVersion { get; set; }
#nullable restore
#else
            [QueryParameter("httpVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetHttpVersionQueryParameterType[] HttpVersion { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetIpVersionQueryParameterType[]? IpVersion { get; set; }
#nullable restore
#else
            [QueryParameter("ipVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetIpVersionQueryParameterType[] IpVersion { get; set; }
...
#nullable enable
            [QueryParameter("os")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetOsQueryParameterType[]? Os { get; set; }
#nullable restore
#else
            [QueryParameter("os")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Ases.Tls_version.Item.GetOsQueryParameterType[] Os { get; set; }
