...
namespace Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item
{
    ...
    public partial class WithIp_versionItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopLocationsByIpVersion200"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopLocationsByIpVersion404">When receiving a 404 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopLocationsByIpVersion200?> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.WithIp_versionItemRequestBuilder.WithIp_versionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopLocationsByIpVersion200> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.WithIp_versionItemRequestBuilder.WithIp_versionItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "404", global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopLocationsByIpVersion404.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopLocationsByIpVersion200>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.RadarGetHttpTopLocationsByIpVersion200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieves the top locations, by HTTP requests, of the requested IP version.
        /// </summary>
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetBotClassQueryParameterType[]? BotClass { get; set; }
#nullable restore
#else
            [QueryParameter("botClass")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetBotClassQueryParameterType[] BotClass { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetBrowserFamilyQueryParameterType[]? BrowserFamily { get; set; }
#nullable restore
#else
            [QueryParameter("browserFamily")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetBrowserFamilyQueryParameterType[] BrowserFamily { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetDeviceTypeQueryParameterType[]? DeviceType { get; set; }
#nullable restore
#else
            [QueryParameter("deviceType")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetDeviceTypeQueryParameterType[] DeviceType { get; set; }
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetFormatQueryParameterType? Format { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetHttpProtocolQueryParameterType[]? HttpProtocol { get; set; }
#nullable restore
#else
            [QueryParameter("httpProtocol")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetHttpProtocolQueryParameterType[] HttpProtocol { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetHttpVersionQueryParameterType[]? HttpVersion { get; set; }
#nullable restore
#else
            [QueryParameter("httpVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetHttpVersionQueryParameterType[] HttpVersion { get; set; }
...
#nullable enable
            [QueryParameter("os")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetOsQueryParameterType[]? Os { get; set; }
#nullable restore
#else
            [QueryParameter("os")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetOsQueryParameterType[] Os { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetTlsVersionQueryParameterType[]? TlsVersion { get; set; }
#nullable restore
#else
            [QueryParameter("tlsVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Ip_version.Item.GetTlsVersionQueryParameterType[] TlsVersion { get; set; }
