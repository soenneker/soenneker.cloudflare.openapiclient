...
{
    /// <summary>
    /// Builds and executes requests for operations under \accounts\{account-id}\rulesets\{ruleset_id}\rules
    /// </summary>
    ...
    public partial class RulesRequestBuilder : BaseRequestBuilder
    {
        ...
        public RulesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/rulesets/{ruleset_id}/rules", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Rulesets.Item.Rules.RulesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RulesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/rulesets/{ruleset_id}/rules", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Rulesets.Item.Rules.RulesPostResponse?> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Rulesets.Item.Rules.RulesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Rulesets.Item.Rules.RulesPostResponse> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Rulesets.Item.Rules.RulesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
