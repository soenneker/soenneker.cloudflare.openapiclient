...
{
    /// <summary>
    /// Builds and executes requests for operations under \accounts\{account-id}\gateway\certificates\{certificate_id}\deactivate
    /// </summary>
    ...
    public partial class DeactivateRequestBuilder : BaseRequestBuilder
    {
        ...
        public DeactivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/gateway/certificates/{certificate_id}/deactivate", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Gateway.Certificates.Item.Deactivate.DeactivateRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeactivateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/gateway/certificates/{certificate_id}/deactivate", rawUrl)
        {
        }
        /// <summary>
