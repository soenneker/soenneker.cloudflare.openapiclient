...
using Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Access.Users.Item.Mfa_authenticators;
...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Access.Users.Item
{
    ...
    public partial class WithUser_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>The mfa_authenticators property</summary>
        public global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Access.Users.Item.Mfa_authenticators.Mfa_authenticatorsRequestBuilder Mfa_authenticators
        {
            get => new global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Access.Users.Item.Mfa_authenticators.Mfa_authenticatorsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.AccessDeleteUserResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.AccessDeleteUserResponse?> DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.AccessDeleteUserResponse> DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.AccessDeleteUserResponse>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.AccessDeleteUserResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.AccessSingleUserResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.AccessSingleUserResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.AccessSingleUserResponse?> PutAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.ZeroTrustUsersUpdateUser body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.AccessSingleUserResponse> PutAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.ZeroTrustUsersUpdateUser body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.ZeroTrustUsersUpdateUser body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.ZeroTrustUsersUpdateUser body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Access.Users.Item.WithUser_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Access.Users.Item.WithUser_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
