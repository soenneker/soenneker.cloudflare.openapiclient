...
{
    /// <summary>
    /// Builds and executes requests for operations under \accounts\{account-id}\addressing\address_maps\{address_map_id}\zones
    /// </summary>
    ...
    public partial class ZonesRequestBuilder : BaseRequestBuilder
    {
        ...
        public ZonesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/addressing/address_maps/{address_map_id}/zones", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Addressing.Address_maps.Item.Zones.ZonesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ZonesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/addressing/address_maps/{address_map_id}/zones", rawUrl)
        {
        }
    }
}
