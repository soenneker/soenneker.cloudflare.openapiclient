...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Event_subscriptions.Subscriptions
{
    ...
    public partial class SubscriptionsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsList200"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsList200?> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Event_subscriptions.Subscriptions.SubscriptionsRequestBuilder.SubscriptionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsList200> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Event_subscriptions.Subscriptions.SubscriptionsRequestBuilder.SubscriptionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsList200>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsList200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Create a new event subscription for a queue
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsCreate200"/></returns>
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.MqApiV4Failure">When receiving a 405 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsCreate200?> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsCreate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsCreate200> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsCreate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "405", global::Soenneker.Cloudflare.OpenApiClient.Models.MqApiV4Failure.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsCreate200>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsCreate200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get a paginated list of event subscriptions with optional sorting and filtering
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsCreate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.SubscriptionsCreate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        public partial class SubscriptionsRequestBuilderGetQueryParameters 
        {
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Event_subscriptions.Subscriptions.GetDirectionQueryParameterType? Direction { get; set; }
            /// <summary>Field to sort by</summary>
            [QueryParameter("order")]
            public global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Event_subscriptions.Subscriptions.GetOrderQueryParameterType? Order { get; set; }
