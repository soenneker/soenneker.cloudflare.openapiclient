...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Secrets_store.Stores.Item
{
    ...
    public partial class WithStore_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithStore_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/secrets_store/stores/{store_id}{?force*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Secrets_store.Stores.Item.WithStore_ItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithStore_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/secrets_store/stores/{store_id}{?force*}", rawUrl)
        {
        }
        /// <summary>
        /// Deletes a single store. By default, a store that still contains secretscannot be deleted and returns HTTP 409 (Conflict) with the &quot;store_not_empty&quot;error. Pass `force=true` to cascade-delete all secrets in the store.Empty stores are always deleted regardless of the force parameter.
        /// </summary>
        ...
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.SecretsStoreDeleteById409">When receiving a 409 status code</exception>
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.SecretsStoreDeleteById4XX">When receiving a 4XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.SecretsStoreDeleteResponse?> DeleteAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Secrets_store.Stores.Item.WithStore_ItemRequestBuilder.WithStore_ItemRequestBuilderDeleteQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.SecretsStoreDeleteResponse> DeleteAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Secrets_store.Stores.Item.WithStore_ItemRequestBuilder.WithStore_ItemRequestBuilderDeleteQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "409", global::Soenneker.Cloudflare.OpenApiClient.Models.SecretsStoreDeleteById409.CreateFromDiscriminatorValue },
                { "4XX", global::Soenneker.Cloudflare.OpenApiClient.Models.SecretsStoreDeleteById4XX.CreateFromDiscriminatorValue },
            };
        ...
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.SecretsStoreGetStoreById4XX">When receiving a 4XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.SecretsStoreStoreResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                { "4XX", global::Soenneker.Cloudflare.OpenApiClient.Models.SecretsStoreGetStoreById4XX.CreateFromDiscriminatorValue },
            };
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Secrets_store.Stores.Item.WithStore_ItemRequestBuilder.WithStore_ItemRequestBuilderDeleteQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Secrets_store.Stores.Item.WithStore_ItemRequestBuilder.WithStore_ItemRequestBuilderDeleteQueryParameters>> requestConfiguration = default)
