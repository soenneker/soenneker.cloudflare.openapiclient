...
using Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Logs.Explorer;
...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Logs
{
    ...
    public partial class LogsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Logs.Explorer.ExplorerRequestBuilder Explorer
        {
            get => new global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Logs.Explorer.ExplorerRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        ...
        public LogsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/logs", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.Logs.LogsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LogsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_identifier%2Did}/logs", rawUrl)
        {
        }
    }
}
