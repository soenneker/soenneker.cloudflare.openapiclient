...
namespace Soenneker.Cloudflare.OpenApiClient.Accounts.Item.CloudforceOne.Requests.Item.Asset
{
    ...
    public partial class AssetRequestBuilder : BaseRequestBuilder
    {
        ...
        public AssetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/cloudforce-one/requests/{request_id}/asset", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Accounts.Item.CloudforceOne.Requests.Item.Asset.AssetRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AssetRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account%2Did}/cloudforce-one/requests/{request_id}/asset", rawUrl)
        {
        }
        /// <summary>
        /// List Request Assets
...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Cloudforce_one_request_asset_list_200?> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Cloudforce_one_requests_request_asset_list body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Cloudforce_one_request_asset_list_200> PostAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Cloudforce_one_requests_request_asset_list body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Cloudforce_one_requests_request_asset_list body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Cloudforce_one_requests_request_asset_list body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
