...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class AbuseReportsThreatReport : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsThreatReport_host_notification? HostNotification { get; set; }
...
#endif
        /// <summary>&quot;Notification type based on the abuse type. NOTE: Copyright (DMCA) and Trademark reports cannot be anonymous.&quot;</summary>
        public global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsThreatReport_owner_notification? OwnerNotification { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsThreatReport"/> and sets the default values.
        /// </summary>
        public AbuseReportsThreatReport()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsThreatReport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsThreatReport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsThreatReport();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "host_notification", n => { HostNotification = n.GetEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsThreatReport_host_notification>(); } },
                { "justification", n => { Justification = n.GetStringValue(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "owner_notification", n => { OwnerNotification = n.GetEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsThreatReport_owner_notification>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsThreatReport_host_notification>("host_notification", HostNotification);
            writer.WriteStringValue("justification", Justification);
            writer.WriteStringValue("name", Name);
            writer.WriteEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsThreatReport_owner_notification>("owner_notification", OwnerNotification);
