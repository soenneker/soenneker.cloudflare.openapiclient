...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class PostEventCreate : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate_indicators>? Indicators { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate_indicators> Indicators { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate_raw? Raw { get; set; }
#nullable restore
#else
        public global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate_raw Raw { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate"/> and sets the default values.
        /// </summary>
        public PostEventCreate()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "indicators", n => { Indicators = n.GetCollectionOfObjectValues<global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate_indicators>(global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate_indicators.CreateFromDiscriminatorValue)?.AsList(); } },
                { "insight", n => { Insight = n.GetStringValue(); } },
                { "raw", n => { Raw = n.GetObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate_raw>(global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate_raw.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate_indicators>("indicators", Indicators);
            writer.WriteStringValue("indicatorType", IndicatorType);
            writer.WriteStringValue("insight", Insight);
            writer.WriteObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.PostEventCreate_raw>("raw", Raw);
