...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class CloudflarePipelinesR2DataCatalogTablePublicRollingPolicy : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.CloudflarePipelinesR2DataCatalogTablePublicRollingPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.CloudflarePipelinesR2DataCatalogTablePublicRollingPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.CloudflarePipelinesR2DataCatalogTablePublicRollingPolicy();
        }
        /// <summary>
