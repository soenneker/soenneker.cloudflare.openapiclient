...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class WorkersAiPostRunCfMetaLlama318bInstructFp8FastMember1 : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Cloudflare.OpenApiClient.Models.WorkersAiPostRunCfMetaLlama318bInstructFp8FastMember1_response_format? ResponseFormat { get; set; }
#nullable restore
#else
        public global::Soenneker.Cloudflare.OpenApiClient.Models.WorkersAiPostRunCfMetaLlama318bInstructFp8FastMember1_response_format ResponseFormat { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.WorkersAiPostRunCfMetaLlama318bInstructFp8FastMember1"/> and sets the default values.
        /// </summary>
        public WorkersAiPostRunCfMetaLlama318bInstructFp8FastMember1()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.WorkersAiPostRunCfMetaLlama318bInstructFp8FastMember1"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.WorkersAiPostRunCfMetaLlama318bInstructFp8FastMember1 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.WorkersAiPostRunCfMetaLlama318bInstructFp8FastMember1();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "response_format", n => { ResponseFormat = n.GetObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.WorkersAiPostRunCfMetaLlama318bInstructFp8FastMember1_response_format>(global::Soenneker.Cloudflare.OpenApiClient.Models.WorkersAiPostRunCfMetaLlama318bInstructFp8FastMember1_response_format.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.WorkersAiPostRunCfMetaLlama318bInstructFp8FastMember1_response_format>("response_format", ResponseFormat);
