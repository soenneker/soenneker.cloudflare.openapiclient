...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class SmartshieldQueryHealthcheck : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldHttpConfig? HttpConfig { get; set; }
#nullable restore
#else
        public global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldHttpConfig HttpConfig { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldTcpConfig? TcpConfig { get; set; }
#nullable restore
#else
        public global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldTcpConfig TcpConfig { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldQueryHealthcheck"/> and sets the default values.
        /// </summary>
        public SmartshieldQueryHealthcheck()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldQueryHealthcheck"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldQueryHealthcheck CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldQueryHealthcheck();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "http_config", n => { HttpConfig = n.GetObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldHttpConfig>(global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldHttpConfig.CreateFromDiscriminatorValue); } },
                { "interval", n => { Interval = n.GetIntValue(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "retries", n => { Retries = n.GetIntValue(); } },
                { "suspended", n => { Suspended = n.GetBoolValue(); } },
                { "tcp_config", n => { TcpConfig = n.GetObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldTcpConfig>(global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldTcpConfig.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldHttpConfig>("http_config", HttpConfig);
            ...
            writer.WriteObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.SmartshieldTcpConfig>("tcp_config", TcpConfig);
