...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class Cloudflare_pipelines_r2TablePublic_rolling_policy : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Cloudflare_pipelines_r2TablePublic_rolling_policy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.Cloudflare_pipelines_r2TablePublic_rolling_policy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.Cloudflare_pipelines_r2TablePublic_rolling_policy();
        }
        /// <summary>
