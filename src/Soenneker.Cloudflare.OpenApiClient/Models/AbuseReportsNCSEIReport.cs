...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class AbuseReportsNCSEIReport : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsNCSEIReport_host_notification? HostNotification { get; set; }
        /// <summary>Text not exceeding 255 characters. This field may be released by Cloudflare to third parties such as the Lumen Database (https://lumendatabase.org/).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>&quot;Notification type based on the abuse type. NOTE: Copyright (DMCA) and Trademark reports cannot be anonymous.&quot;</summary>
        public global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsNCSEIReport_owner_notification? OwnerNotification { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsNCSEIReport"/> and sets the default values.
        /// </summary>
        public AbuseReportsNCSEIReport()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsNCSEIReport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsNCSEIReport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsNCSEIReport();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "host_notification", n => { HostNotification = n.GetEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsNCSEIReport_host_notification>(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "ncsei_subject_representation", n => { NcseiSubjectRepresentation = n.GetBoolValue(); } },
                { "owner_notification", n => { OwnerNotification = n.GetEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsNCSEIReport_owner_notification>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsNCSEIReport_host_notification>("host_notification", HostNotification);
            writer.WriteStringValue("name", Name);
            writer.WriteBoolValue("ncsei_subject_representation", NcseiSubjectRepresentation);
            writer.WriteEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsNCSEIReport_owner_notification>("owner_notification", OwnerNotification);
