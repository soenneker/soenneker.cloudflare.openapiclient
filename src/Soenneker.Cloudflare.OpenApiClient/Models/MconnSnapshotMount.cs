...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class MconnSnapshotMount : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Available disk size (bytes)</summary>
        public double? AvailableBytes { get; set; }
        /// <summary>Available inodes on filesystem</summary>
        public double? AvailableInodes { get; set; }
...
#nullable restore
        ...
        /// <summary>Total inodes on filesystem</summary>
        public double? TotalInodes { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.MconnSnapshotMount"/> and sets the default values.
        /// </summary>
        public MconnSnapshotMount()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.MconnSnapshotMount"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.MconnSnapshotMount CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.MconnSnapshotMount();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "available_inodes", n => { AvailableInodes = n.GetDoubleValue(); } },
                ...
                { "total_inodes", n => { TotalInodes = n.GetDoubleValue(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteDoubleValue("available_inodes", AvailableInodes);
            ...
            writer.WriteDoubleValue("total_inodes", TotalInodes);
