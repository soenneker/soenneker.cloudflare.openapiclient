...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class AbuseReportsDMCAReport : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsDMCAReport_host_notification? HostNotification { get; set; }
        /// <summary>Text not exceeding 255 characters. This field may be released by Cloudflare to third parties such as the Lumen Database (https://lumendatabase.org/).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#endif
        /// <summary>&quot;Notification type based on the abuse type. NOTE: Copyright (DMCA) and Trademark reports cannot be anonymous.&quot;</summary>
        public global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsDMCAReport_owner_notification? OwnerNotification { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsDMCAReport"/> and sets the default values.
        /// </summary>
        public AbuseReportsDMCAReport()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsDMCAReport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsDMCAReport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsDMCAReport();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "host_notification", n => { HostNotification = n.GetEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsDMCAReport_host_notification>(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "original_work", n => { OriginalWork = n.GetStringValue(); } },
                { "owner_notification", n => { OwnerNotification = n.GetEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsDMCAReport_owner_notification>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsDMCAReport_host_notification>("host_notification", HostNotification);
            writer.WriteStringValue("name", Name);
            writer.WriteStringValue("original_work", OriginalWork);
            writer.WriteEnumValue<global::Soenneker.Cloudflare.OpenApiClient.Models.AbuseReportsDMCAReport_owner_notification>("owner_notification", OwnerNotification);
