...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class Stream_watermark_profile_create_watermark_profiles_via_basic_uploadapplication_json : IAdditionalDataHolder, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Stream_watermark_profile_create_watermark_profiles_via_basic_uploadapplication_json"/> and sets the default values.
        /// </summary>
        public Stream_watermark_profile_create_watermark_profiles_via_basic_uploadapplication_json()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Stream_watermark_profile_create_watermark_profiles_via_basic_uploadapplication_json"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.Stream_watermark_profile_create_watermark_profiles_via_basic_uploadapplication_json CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.Stream_watermark_profile_create_watermark_profiles_via_basic_uploadapplication_json();
        }
        /// <summary>
