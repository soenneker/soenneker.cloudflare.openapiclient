...
namespace Soenneker.Cloudflare.OpenApiClient.Models
{
    ...
    public partial class HealthchecksQueryHealthcheck : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksHttpConfig? HttpConfig { get; set; }
#nullable restore
#else
        public global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksHttpConfig HttpConfig { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksTcpConfig? TcpConfig { get; set; }
#nullable restore
#else
        public global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksTcpConfig TcpConfig { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksQueryHealthcheck"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksQueryHealthcheck"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksQueryHealthcheck CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksQueryHealthcheck();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "http_config", n => { HttpConfig = n.GetObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksHttpConfig>(global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksHttpConfig.CreateFromDiscriminatorValue); } },
                { "interval", n => { Interval = n.GetIntValue(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "retries", n => { Retries = n.GetIntValue(); } },
                { "suspended", n => { Suspended = n.GetBoolValue(); } },
                { "tcp_config", n => { TcpConfig = n.GetObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksTcpConfig>(global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksTcpConfig.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksHttpConfig>("http_config", HttpConfig);
            ...
            writer.WriteObjectValue<global::Soenneker.Cloudflare.OpenApiClient.Models.HealthchecksTcpConfig>("tcp_config", TcpConfig);
