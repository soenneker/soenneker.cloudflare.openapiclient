...
namespace Soenneker.Cloudflare.Radar.Ai.Bots.Timeseries_groups.User_agent
{
    ...
    public partial class User_agentRequestBuilder : BaseRequestBuilder
    {
        ...
        public User_agentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/ai/bots/timeseries_groups/user_agent", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.Radar.Ai.Bots.Timeseries_groups.User_agent.User_agentRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public User_agentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/ai/bots/timeseries_groups/user_agent", rawUrl)
        {
        }
        /// <summary>
