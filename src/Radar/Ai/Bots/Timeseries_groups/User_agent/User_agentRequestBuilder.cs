...
namespace Soenneker.Cloudflare.OpenApiClient.Radar.Ai.Bots.Timeseries_groups.User_agent
{
    ...
    public partial class User_agentRequestBuilder : BaseRequestBuilder
    {
        ...
        public User_agentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/ai/bots/timeseries_groups/user_agent{?aggInterval*,asn*,continent*,dateEnd*,dateRange*,dateStart*,format*,limitPerGroup*,location*,name*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Radar.Ai.Bots.Timeseries_groups.User_agent.User_agentRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public User_agentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/ai/bots/timeseries_groups/user_agent{?aggInterval*,asn*,continent*,dateEnd*,dateRange*,dateStart*,format*,limitPerGroup*,location*,name*}", rawUrl)
        {
        }
        /// <summary>
        /// Retrieves the distribution of traffic by AI user agent over time.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_ai_bots_timeseries_group_by_user_agent_200"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_ai_bots_timeseries_group_by_user_agent_400">When receiving a 400 status code</exception>
        [Obsolete("")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_ai_bots_timeseries_group_by_user_agent_200?> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Ai.Bots.Timeseries_groups.User_agent.User_agentRequestBuilder.User_agentRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_ai_bots_timeseries_group_by_user_agent_200> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Ai.Bots.Timeseries_groups.User_agent.User_agentRequestBuilder.User_agentRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_ai_bots_timeseries_group_by_user_agent_400.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_ai_bots_timeseries_group_by_user_agent_200>(requestInfo, global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_ai_bots_timeseries_group_by_user_agent_200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieves the distribution of traffic by AI user agent over time.
        /// </summary>
...
#nullable restore
        ...
        public partial class User_agentRequestBuilderGetQueryParameters 
        {
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ai.Bots.Timeseries_groups.User_agent.GetAggIntervalQueryParameterType? AggInterval { get; set; }
...
#nullable restore
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ai.Bots.Timeseries_groups.User_agent.GetFormatQueryParameterType? Format { get; set; }
