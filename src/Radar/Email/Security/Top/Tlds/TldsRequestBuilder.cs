...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_email_security_top_tlds_by_messages_Response_200_application_json?> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Top.Tlds.TldsRequestBuilder.TldsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_email_security_top_tlds_by_messages_Response_200_application_json> GetAsync(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Top.Tlds.TldsRequestBuilder.TldsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Top.Tlds.TldsRequestBuilder.TldsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Top.Tlds.TldsRequestBuilder.TldsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
            ...
            /// <summary>Format in which results will be returned.</summary>
            [QueryParameter("format")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Top.Tlds.GetFormatQueryParameterType? FormatAsGetFormatQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Filters results by TLD category.</summary>
            [QueryParameter("tldCategory")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Top.Tlds.GetTldCategoryQueryParameterType? TldCategoryAsGetTldCategoryQueryParameterType { get; set; }
