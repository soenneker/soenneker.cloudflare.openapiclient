...
#nullable enable
            [QueryParameter("arc")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Summary.Spam.GetArcQueryParameterType[]? Arc { get; set; }
#nullable restore
#else
            [QueryParameter("arc")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Summary.Spam.GetArcQueryParameterType[] Arc { get; set; }
...
#nullable enable
            [QueryParameter("dkim")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Summary.Spam.GetDkimQueryParameterType[]? Dkim { get; set; }
#nullable restore
#else
            [QueryParameter("dkim")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Summary.Spam.GetDkimQueryParameterType[] Dkim { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Summary.Spam.GetDmarcQueryParameterType[]? Dmarc { get; set; }
#nullable restore
#else
            [QueryParameter("dmarc")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Summary.Spam.GetDmarcQueryParameterType[] Dmarc { get; set; }
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Summary.Spam.GetFormatQueryParameterType? Format { get; set; }
...
#nullable enable
            [QueryParameter("spf")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Summary.Spam.GetSpfQueryParameterType[]? Spf { get; set; }
#nullable restore
#else
            [QueryParameter("spf")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Summary.Spam.GetSpfQueryParameterType[] Spf { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Summary.Spam.GetTlsVersionQueryParameterType[]? TlsVersion { get; set; }
#nullable restore
#else
            [QueryParameter("tlsVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Email.Security.Summary.Spam.GetTlsVersionQueryParameterType[] TlsVersion { get; set; }
