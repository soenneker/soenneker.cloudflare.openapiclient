...
namespace Soenneker.Cloudflare.Radar.As112.Top.Locations.Edns.Item
{
    ...
    public partial class WithEdnsItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithEdnsItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/as112/top/locations/edns/{edns}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.Radar.As112.Top.Locations.Edns.Item.WithEdnsItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithEdnsItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/as112/top/locations/edns/{edns}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithEdnsItemRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
