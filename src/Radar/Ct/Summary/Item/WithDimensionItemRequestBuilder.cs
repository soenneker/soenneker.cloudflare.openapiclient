...
#nullable enable
            [QueryParameter("duration")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetDurationQueryParameterType[]? DurationAsGetDurationQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("duration")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetDurationQueryParameterType[] DurationAsGetDurationQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("entryType")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetEntryTypeQueryParameterType[]? EntryTypeAsGetEntryTypeQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("entryType")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetEntryTypeQueryParameterType[] EntryTypeAsGetEntryTypeQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("expirationStatus")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetExpirationStatusQueryParameterType[]? ExpirationStatusAsGetExpirationStatusQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("expirationStatus")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetExpirationStatusQueryParameterType[] ExpirationStatusAsGetExpirationStatusQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Format in which results will be returned.</summary>
            [QueryParameter("format")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetFormatQueryParameterType? FormatAsGetFormatQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("logApi")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetLogApiQueryParameterType[]? LogApiAsGetLogApiQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("logApi")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetLogApiQueryParameterType[] LogApiAsGetLogApiQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Normalization method applied to the results. Refer to [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).</summary>
            [QueryParameter("normalization")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetNormalizationQueryParameterType? NormalizationAsGetNormalizationQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("publicKeyAlgorithm")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetPublicKeyAlgorithmQueryParameterType[]? PublicKeyAlgorithmAsGetPublicKeyAlgorithmQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("publicKeyAlgorithm")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetPublicKeyAlgorithmQueryParameterType[] PublicKeyAlgorithmAsGetPublicKeyAlgorithmQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("signatureAlgorithm")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetSignatureAlgorithmQueryParameterType[]? SignatureAlgorithmAsGetSignatureAlgorithmQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("signatureAlgorithm")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetSignatureAlgorithmQueryParameterType[] SignatureAlgorithmAsGetSignatureAlgorithmQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("uniqueEntries")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetUniqueEntriesQueryParameterType[]? UniqueEntriesAsGetUniqueEntriesQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("uniqueEntries")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetUniqueEntriesQueryParameterType[] UniqueEntriesAsGetUniqueEntriesQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("validationLevel")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetValidationLevelQueryParameterType[]? ValidationLevelAsGetValidationLevelQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("validationLevel")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.GetValidationLevelQueryParameterType[] ValidationLevelAsGetValidationLevelQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithDimensionItemRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Ct.Summary.Item.WithDimensionItemRequestBuilder.WithDimensionItemRequestBuilderGetQueryParameters>
        {
        }
    }
}
