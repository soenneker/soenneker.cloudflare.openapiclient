...
namespace Soenneker.Cloudflare.Radar.Http.Summary.Bot_class
{
    ...
    public partial class Bot_classRequestBuilder : BaseRequestBuilder
    {
        ...
        public Bot_classRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/http/summary/bot_class", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.Radar.Http.Summary.Bot_class.Bot_classRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Bot_classRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/http/summary/bot_class", rawUrl)
        {
        }
        /// <summary>
