...
namespace Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class
{
    ...
    public partial class Bot_classRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Bot_classRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/http/summary/bot_class{?asn*,browserFamily*,continent*,dateEnd*,dateRange*,dateStart*,deviceType*,format*,geoId*,httpProtocol*,httpVersion*,ipVersion*,location*,name*,os*,tlsVersion*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetBrowserFamilyQueryParameterType[]? BrowserFamily { get; set; }
#nullable restore
#else
            [QueryParameter("browserFamily")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetBrowserFamilyQueryParameterType[] BrowserFamily { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetDeviceTypeQueryParameterType[]? DeviceType { get; set; }
#nullable restore
#else
            [QueryParameter("deviceType")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetDeviceTypeQueryParameterType[] DeviceType { get; set; }
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetFormatQueryParameterType? Format { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetHttpProtocolQueryParameterType[]? HttpProtocol { get; set; }
#nullable restore
#else
            [QueryParameter("httpProtocol")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetHttpProtocolQueryParameterType[] HttpProtocol { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetHttpVersionQueryParameterType[]? HttpVersion { get; set; }
#nullable restore
#else
            [QueryParameter("httpVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetHttpVersionQueryParameterType[] HttpVersion { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetIpVersionQueryParameterType[]? IpVersion { get; set; }
#nullable restore
#else
            [QueryParameter("ipVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetIpVersionQueryParameterType[] IpVersion { get; set; }
...
#nullable enable
            [QueryParameter("os")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetOsQueryParameterType[]? Os { get; set; }
#nullable restore
#else
            [QueryParameter("os")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetOsQueryParameterType[] Os { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetTlsVersionQueryParameterType[]? TlsVersion { get; set; }
#nullable restore
#else
            [QueryParameter("tlsVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Bot_class.GetTlsVersionQueryParameterType[] TlsVersion { get; set; }
