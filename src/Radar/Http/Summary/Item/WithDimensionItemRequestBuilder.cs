...
{
    /// <summary>
    /// Builds and executes requests for operations under \radar\http\summary\{dimension}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithDimensionItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.WithDimensionItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithDimensionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/http/summary/{dimension}{?asn*,botClass*,continent*,dateEnd*,dateRange*,dateStart*,deviceType*,format*,httpProtocol*,httpVersion*,ipVersion*,limitPerGroup*,location*,name*,os*,tlsVersion*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.WithDimensionItemRequestBuilder.WithDimensionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.WithDimensionItemRequestBuilder.WithDimensionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.WithDimensionItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.WithDimensionItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieves the distribution of HTTP requests by the specified dimension.
        /// </summary>
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetBotClassQueryParameterType[]? BotClass { get; set; }
#nullable restore
#else
            [QueryParameter("botClass")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetBotClassQueryParameterType[] BotClass { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetDeviceTypeQueryParameterType[]? DeviceType { get; set; }
#nullable restore
#else
            [QueryParameter("deviceType")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetDeviceTypeQueryParameterType[] DeviceType { get; set; }
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetFormatQueryParameterType? Format { get; set; }
            /// <summary>Filters results by HTTP protocol (HTTP vs. HTTPS).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            [QueryParameter("httpProtocol")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetHttpProtocolQueryParameterType[]? HttpProtocol { get; set; }
#nullable restore
#else
            [QueryParameter("httpProtocol")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetHttpProtocolQueryParameterType[] HttpProtocol { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetHttpVersionQueryParameterType[]? HttpVersion { get; set; }
#nullable restore
#else
            [QueryParameter("httpVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetHttpVersionQueryParameterType[] HttpVersion { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetIpVersionQueryParameterType[]? IpVersion { get; set; }
#nullable restore
#else
            [QueryParameter("ipVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetIpVersionQueryParameterType[] IpVersion { get; set; }
...
#nullable enable
            [QueryParameter("os")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetOsQueryParameterType[]? Os { get; set; }
#nullable restore
#else
            [QueryParameter("os")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetOsQueryParameterType[] Os { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetTlsVersionQueryParameterType[]? TlsVersion { get; set; }
#nullable restore
#else
            [QueryParameter("tlsVersion")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Summary.Item.GetTlsVersionQueryParameterType[] TlsVersion { get; set; }
