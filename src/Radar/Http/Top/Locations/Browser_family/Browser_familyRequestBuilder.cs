...
namespace Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Browser_family
{
    ...
    public partial class Browser_familyRequestBuilder : BaseRequestBuilder
    {
        ...
        public Browser_familyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/http/top/locations/browser_family", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Radar.Http.Top.Locations.Browser_family.Browser_familyRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Browser_familyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/http/top/locations/browser_family", rawUrl)
        {
        }
    }
}
