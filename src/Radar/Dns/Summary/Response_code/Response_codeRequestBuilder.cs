...
namespace Soenneker.Cloudflare.Radar.Dns.Summary.Response_code
{
    ...
    public partial class Response_codeRequestBuilder : BaseRequestBuilder
    {
        ...
        public Response_codeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/dns/summary/response_code", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.Radar.Dns.Summary.Response_code.Response_codeRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Response_codeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/dns/summary/response_code", rawUrl)
        {
        }
        /// <summary>
