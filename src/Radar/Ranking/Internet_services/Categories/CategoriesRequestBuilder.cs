...
namespace Soenneker.Cloudflare.Radar.Ranking.Internet_services.Categories
{
    ...
    public partial class CategoriesRequestBuilder : BaseRequestBuilder
    {
        ...
        public CategoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/ranking/internet_services/categories", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.Radar.Ranking.Internet_services.Categories.CategoriesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CategoriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/ranking/internet_services/categories", rawUrl)
        {
        }
        /// <summary>
