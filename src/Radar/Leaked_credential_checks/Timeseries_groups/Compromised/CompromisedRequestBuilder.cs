...
#nullable enable
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_leaked_credential_checks_timeseries_group_by_compromised_Response_200_application_json?> GetAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_leaked_credential_checks_timeseries_group_by_compromised_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Leaked_credential_checks.Timeseries_groups.Compromised.CompromisedRequestBuilder.CompromisedRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_leaked_credential_checks_timeseries_group_by_compromised_Response_200_application_json> GetAsync(global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_leaked_credential_checks_timeseries_group_by_compromised_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Leaked_credential_checks.Timeseries_groups.Compromised.CompromisedRequestBuilder.CompromisedRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_leaked_credential_checks_timeseries_group_by_compromised_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Leaked_credential_checks.Timeseries_groups.Compromised.CompromisedRequestBuilder.CompromisedRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_leaked_credential_checks_timeseries_group_by_compromised_RequestBody_application_json body, Action<RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Leaked_credential_checks.Timeseries_groups.Compromised.CompromisedRequestBuilder.CompromisedRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        public partial class CompromisedRequestBuilderGetQueryParameters 
        {
            ...
            [Obsolete("This property is deprecated, use AggIntervalAsRadarGetLeakedCredentialChecksTimeseriesGroupByCompromisedParamAggInterval instead")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            /// <summary>Aggregation interval of the results (e.g., in 15 minutes or 1 hour intervals). Refer to [Aggregation intervals](https://developers.cloudflare.com/radar/concepts/aggregation-intervals/).</summary>
            [QueryParameter("aggInterval")]
            public global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_leaked_credential_checks_timeseries_group_by_compromised_Param_aggInterval? AggIntervalAsRadarGetLeakedCredentialChecksTimeseriesGroupByCompromisedParamAggInterval { get; set; }
...
#nullable restore
            ...
            [Obsolete("This property is deprecated, use FormatAsRadarGetLeakedCredentialChecksTimeseriesGroupByCompromisedParamFormat instead")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            /// <summary>Format in which results will be returned.</summary>
            [QueryParameter("format")]
            public global::Soenneker.Cloudflare.OpenApiClient.Models.Radar_get_leaked_credential_checks_timeseries_group_by_compromised_Param_format? FormatAsRadarGetLeakedCredentialChecksTimeseriesGroupByCompromisedParamFormat { get; set; }
