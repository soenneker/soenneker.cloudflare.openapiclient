...
namespace Soenneker.Cloudflare.OpenApiClient.Radar.Bots.Crawlers.Summary.Item
{
    ...
    public partial class WithDimensionItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithDimensionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/bots/crawlers/summary/{dimension}{?botOperator*,dateEnd*,dateRange*,dateStart*,format*,limitPerGroup*,name*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.OpenApiClient.Radar.Bots.Crawlers.Summary.Item.WithDimensionItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithDimensionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/radar/bots/crawlers/summary/{dimension}{?botOperator*,dateEnd*,dateRange*,dateStart*,format*,limitPerGroup*,name*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
            ...
            /// <summary>Format in which results will be returned.</summary>
            [QueryParameter("format")]
            public global::Soenneker.Cloudflare.OpenApiClient.Radar.Bots.Crawlers.Summary.Item.GetFormatQueryParameterType? FormatAsGetFormatQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithDimensionItemRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Cloudflare.OpenApiClient.Radar.Bots.Crawlers.Summary.Item.WithDimensionItemRequestBuilder.WithDimensionItemRequestBuilderGetQueryParameters>
        {
        }
    }
}
