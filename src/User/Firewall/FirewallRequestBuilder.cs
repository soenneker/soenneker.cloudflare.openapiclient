...
namespace Soenneker.Cloudflare.User.Firewall
{
    ...
    public partial class FirewallRequestBuilder : BaseRequestBuilder
    {
        ...
        public FirewallRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user/firewall", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudflare.User.Firewall.FirewallRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FirewallRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user/firewall", rawUrl)
        {
        }
    }
}
